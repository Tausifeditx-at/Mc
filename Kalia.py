...
TOKEN = '7393710887:AAGlrxe-LBUDF4Hj8t_KjfYgc1L755JprIk-Z9TNrFIURNoWI3G6fCndk'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002259039879
CHANNEL_ID = -1002259039879
error_channel_id = -1002259039879
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @Ddos_attcker.*", parse_mode='Markdown')  # Contact owner message
            return
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*Please reach out to the owner for assistance: @Ddos_attcker* 🙏"  # Contact owner message
    else:
